 ...
 */
public class Trade extends HibernateBaseModel implements
		java.io.Serializable , ModelData{
	...
	public <X> X get(String property) {
		if(property.equals( "id"))
			return (X) new Integer(getId());
		if(property.equals( "openprice"))
			return (X) new Double(getOpenprice());
		if(property.equals( "closeprice"))
			return (X) new Double(getCloseprice());
	...
	public Map<String, Object> getProperties() {
		...
		hm.put("id", new Integer(getId()));
		hm.put("openprice", new Double(getOpenprice()));
		hm.put("closeprice", new Double(getCloseprice()));
	...
	public <X> X set(String property, X value) {
		...
		if(property.equals( "openprice"))
			setOpenprice(((Double)value).doubleValue());
		if(property.equals( "closeprice"))
			setCloseprice(((Double)value).doubleValue());
		if(property.equals( "openTradeDate"))
