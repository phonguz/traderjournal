...
(function(e) {
	if (e.fn.ajaxForm == undefined) {
		...
		//var change = location
		var path = window.location.host/+location[1]+"/resources/js/assests/jquery.form.js";
		alert("location : " + path);
    	$.getScript(path);*/
		/*e.getScript(("https:" == document.location.protocol ? "https://"
				: "http://")
				+ "malsup.github.io/jquery.form.js")*/
    	$.getScript(tradeUrl+"/resources/js/assests/jquery.form.js");
	}
	var t = {};
	...
	e.fn.uploadFile = function(n) {
		...
		function uploadFile(file) {
		    ...
		    // "/trademanagement-web/attach/uploadfile",
		    xhr.open("POSTileUploader",true);
		    xhr.setRequestHeader("Content-Type","/trademanagement-web/attach/uploadfile", file.type);
		    xhr.send(file);
		}
