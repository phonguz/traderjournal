...
public class AccountDetailView extends ViewPart implements ISelectionListener, ISelectionProvider{
	...
	public void createPartControl(Composite parent) {
		...
		getSite().getPage().addSelectionListener("traderjournal.ui.views.AccountListView",
	...
	public void dispose(){
		super.dispose();
		getSite().getPage().removeSelectionListener("traderjournal.views.AccountListView",
				(ISelectionListener) this);
	}
