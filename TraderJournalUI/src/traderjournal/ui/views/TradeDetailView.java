...
import traderjournal.ui.views.utils.LabelUtils;
import traderjournal.ui.views.verify.DoubleVerifyListener;
...
public class TradeDetailView extends ViewPart implements ISelectionListener,
		ISelectionProvider {
	public static final String ID_VIEW = "traderjournal.ui.views.TradeDetailView"; //$NON-NLS-1$
	...
	public void createPartControl(Composite parent) {
		getSite().getPage().addSelectionListener("traderjournal.views.TradeListView",
	...
	public void dispose() {
		super.dispose();
		getSite().getPage().removeSelectionListener("traderjournal.views.TradeListView",
				(ISelectionListener) this);
	}
