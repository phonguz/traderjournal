...
public class Trade implements java.io.Serializable {
	...
	public Trade(int id, Trader trader, Instrument instrument, Account account,
			...
			String reference, Double carrycost, Double qty, Set tradeevents) {
		this.id = id;
		this.trader = trader;
	...
	public void refresh() {
		org.hibernate.Transaction tx = DBUtils.getSessionFactory().getCurrentSession().beginTransaction();
		DBUtils.getSessionFactory().getCurrentSession().refresh(this);
